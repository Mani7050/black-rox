        ...
        <main className="flex-1 overflow-y-auto pb-24 md:pb-8 p-4 sm:p-6 bg-muted/20 relative">
          ...
          {activeTab === 'admin_users' && (
            <AdminUsers
              ...
              setEditUserMultiplier={setEditUserMultiplier}
              setShowEditUserModal={setShowEditUserModal}
              setSelectedUserForPlan={setSelectedUserForPlan}
              setAssignedPlanId={setAssignedPlanId}
              setShowAssignPlanModal={setShowAssignPlanModal}
              handleResetUserApi={handleResetUserApi}
